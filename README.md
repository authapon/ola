...
- **ข้อความที่ตอบกลับผู้ใช้จริงๆ ไม่มีแถบวันเวลานี้ปนอยู่เลย** — สิ่งที่ส่งกลับไปหาผู้ใช้คือคำตอบดิบของโมเดิลตรงๆ ไม่เคยผ่านการแปะแถบวันเวลา/ชื่อผู้พูดเลย (แถบนี้มีไว้ให้ "โมเดิลอ่าน" เป็น input เท่านั้น ไม่ใช่สิ่งที่ควรปรากฏใน output) ระบบยังมีกฎกำกับใน system prompt เพิ่มเติมด้วยว่าห้ามโมเดิลพิมพ์แถบแบบนี้ขึ้นเองในคำตอบ กันกรณีโมเดิลเผลอเลียนแบบรูปแบบที่เห็นซ้ำๆ ในบทสนทนา
