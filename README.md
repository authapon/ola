...
- **ข้อควรรู้เรื่องความแม่นยำ:** การอธิบายรูปที่เรียกผ่าน `read_pic` อาจแม่นยำน้อยกว่าตอนแนบรูปให้บอทดูตรงๆ ในเทิร์นเดียวกัน เพราะมี tool call/tool result คั่นกลางระหว่างคำถามจริงกับรูปที่แนบมา ทำให้โมเดิล (โดยเฉพาะโมเดิลขนาดเล็กหรือบางเวอร์ชันที่ต้องพึ่ง cloud routing) มีโอกาส "หลุดโฟกัส" ได้ง่ายกว่า — ระบบมีข้อความกำกับชัดเจนที่ท้ายเทิร์น follow-up ย้ำให้โมเดิลตอบตามสิ่งที่เห็นจริงในรูปเท่านั้น ห้ามเดา และ compaction ก็ถูกสั่งให้เก็บ path ของรูปไว้แบบคำต่อคำเสมอ (ไม่ถอดความทิ้ง) แต่สุดท้ายความแม่นยำยังขึ้นกับว่าโมเดิลที่ใช้ทำตามคำสั่งได้ดีแค่ไหนด้วย
